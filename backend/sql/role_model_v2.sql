...
-- 1. Keep mariocaste as global admin and ensure profile email is populated.
...
-- 2. Optional commercial capacity per fair.
...
-- 3. Useful indexes for manager/fair access checks.
...
-- NOTE:
-- Do not replace profiles_role_check in this shared Supabase project.
-- Other projects currently use additional roles such as "graduate".
-- The Feria Virtual frontend treats unknown roles as participant.
